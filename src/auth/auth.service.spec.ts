...
describe('AuthService', () => {
    ...
    describe('register', () => {
        ...
        it('should successfully register a new user and return tokens', async () => {
            ...
            expect(JwtServiceMock.generateTokens).toHaveBeenCalledWith({ email: registerDto.email });
    ...
    describe('login', () => {
        ...
        it('should successfully login a user and return tokens', async () => {
            ...
            expect(JwtServiceMock.generateTokens).toHaveBeenCalledWith({ email: loginDto.email });
            expect(result).toEqual({
                id: mockUser.id,
                accessToken: mockTokens.accessToken,
                refreshToken: mockTokens.refreshToken,
    ...
    describe('refreshTokens', () => {
        ...
        it('should successfully refresh tokens', async () => {
            ...
            expect(LoggerMock.log).toHaveBeenCalledWith('Tokens refreshed successfully', decodedToken.email);
    ...
    describe('validateUser', () => {
        ...
        it('should return user if credentials are valid', async () => {
            ...
            expect(PasswordHasherMock.compare).toHaveBeenCalledWith(loginDto.password, mockUser.hasPassword);
